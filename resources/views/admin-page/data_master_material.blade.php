          ...
          <table class="table table-bordered table-sm">
              <thead>
                  <tr class="my-bg-primary text-white">
                      <th style="width: 11%">Kode Material</th>
                      <th>Nama Material</th>
...
<div class="modal fade" id="modal-add-material" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title ml-3 font-weight-bold">Tambah Data Material</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ url('/add-new-material') }}" method="POST">
                @csrf
                <div class="modal-body p-3">
                    <div class="row mb-3">
                        <label for="code" class="col-sm-3 col-form-label">Kode Material</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="code" name="code" autofocus >
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="name" class="col-sm-3 col-form-label">Nama Material</label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="modal-edit-material" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title ml-3 font-weight-bold">Tambah Data Material</h5>
            ...
            <form action="{{ url('/edit-new-material') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body p-3">
