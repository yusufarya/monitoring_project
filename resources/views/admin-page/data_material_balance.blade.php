    ...
    <div class="container-fluid">
        <div class="row mx-2">
          ...
          <div class="row justify-content-end mb-2 w-100">
            <a href="/form-material-balance" class="btn float-right btn-add "><i class="fas fa-plus-square"></i> &nbsp; Data</a>
          </div>
                ...
                @foreach ($resultData as $row)
                  <tr>
                      ...
                      <td style=" text-align: center;">
                        <a href="/form-material-balance/{{$row->id}}" class="text-warning"><i class="fas fa-edit"></i></a>
                        &nbsp;
