...
<section class="content">
    <div class="container-fluid">
        <div class="card mx-2 elevation-1 p-3 w-100">
            <form action="/store-job-daily-report" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mx-2">
                    @php
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_contract')is-invalid @enderror" name="value_contract" id="value_contract" value="{{ $dailyReport['value_contract'] ?? '' }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_job')is-invalid @enderror" name="value_total_job" id="value_total_job" value="{{ $dailyReport['value_total_job'] ?? '' }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_material')is-invalid @enderror" name="value_total_material" id="value_total_material" value="{{ $dailyReport['value_total_material'] ?? '' }}" required readonly>
                ...
                <div class="row justify-content-end mx-3">
                    <section class="col-lg-4">
                        <section style="float: right;">
                            <a href="/job-daily-report" class="btn btn-outline-secondary mr-2"><i class="fas fa-backspace"></i> Batal</a>
