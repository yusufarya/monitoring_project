            ...
            <form action="/store-job-daily-report" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mx-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <select class="select-spk_number form-control" name="spk_number" id="spk_number" @isset($dailyReport['spk_number']) disabled @endisset>
                            <option value="">Plih Nomor Spk</option>
                            @foreach ($projectData as $item)
                            <option value="{{ $item->spk_number }}" {{ isset($dailyReport['spk_number']) && $dailyReport['spk_number'] == $item->spk_number ? 'selected' : ''}}>
