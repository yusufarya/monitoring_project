            ...
            <form action="/store-material-balance" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mx-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_contract')is-invalid @enderror" name="value_contract" id="value_contract" value="{{ $balance['value_contract'] ?? '' }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_job')is-invalid @enderror" name="value_total_job" id="value_total_job" value="{{ $balance['value_total_job'] ?? '' }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_material')is-invalid @enderror" name="value_total_material" id="value_total_material" value="{{ $balance['value_total_material'] ?? '' }}" required readonly>
