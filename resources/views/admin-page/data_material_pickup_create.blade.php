            ...
            <form action="/store-material-pickup" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mx-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_contract')is-invalid @enderror" name="value_contract" id="value_contract" value="{{ isset($material_pickup['value_contract']) ? number_format($material_pickup['value_contract'],2, ',', '.') : 0 }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_job')is-invalid @enderror" name="value_total_job" id="value_total_job" value="{{ isset($material_pickup['value_total_job']) ? number_format($material_pickup['value_total_job'],2, ',', '.') : 0 }}" required readonly>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control @error('value_total_material')is-invalid @enderror" name="value_total_material" id="value_total_material" value="{{ isset($material_pickup['value_total_material']) ? number_format($material_pickup['value_total_material'],2, ',', '.') : 0 }}" required readonly>
