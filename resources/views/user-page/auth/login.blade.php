...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <meta name="description" content="Monitoring Proyek, Tenaga Kerja Tangerang">
        <meta name="author" content="Yusuf Aryadilla and Bootstrap contributors">
        <meta name="generator" content="Monitoring Proyek">
        <title>Login - Page · Monitoring Proyek</title>
                ...
                <form class="mt-3" action="/login" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <small class="ms-1 my-color-secondary"><b> Pelatihan coding dari nol </b></small>
                        </div>
                        <div class="col">
